...
function LaborCodeMaintenance() {
  const [showTable, setShowTable] = useState(true);
  const subHeader = "Restoration Labor Class and Billing Codes";
          ...
          <div className="main p-3">
            {showTable ? (
              ...
              <div>
                ...
                <AddNew props={{label1:'Labor Class'}}/>
              </div>
            )}
          </div>
        </div>
...
export default LaborCodeMaintenance;
