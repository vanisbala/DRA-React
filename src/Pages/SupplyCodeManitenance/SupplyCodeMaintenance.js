...
function SupplyCodeMaintenance() {
  const [showTable, setShowTable] = useState(true);
  const subHeader = "Restoration Supplies Class and Billing Codes";
          ...
          <div className="main p-3">
            {showTable ? (
              <div>
                ...
                <Table props={{col1:'Supplies Code Class'}}/>
              </div>
            ) : (
              <div>
                <div className="btn-area py-2 text-end ">
                ...
                <AddNew props={{label1:'Supplies Code Class'}}/>
              </div>
            )}
          </div>
        </div>
...
export default SupplyCodeMaintenance;
